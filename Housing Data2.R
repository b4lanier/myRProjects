...
#change median value to age to test that value
train_y = train[,'housing_median_age']
train_x = train[, names(train) !='housing_median_age']
...
#change median value to age to test that value
test_y = test[,'housing_median_age']
test_x = test[, names(test) !='housing_median_age']
